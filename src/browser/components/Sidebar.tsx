...
const Sidebar: FC<SidebarProps> = (props) => (
  <Wrapper className={props.className}>
    ...
    <Inner>
      <StyledLink title={t("followedStreams")} to="/streams/followed">
        <svg viewBox="0 0 24 24">
          <path d="M19.5 13.572l-7.5 7.428l-7.5 -7.428m0 0a5 5 0 1 1 7.5 -6.566a5 5 0 1 1 7.5 6.572" />
        </svg>
      </StyledLink>
      <StyledLink title={t("followedUsers")} to="/users/followed">
        <svg viewBox="0 0 24 24">
      ...
      <Separator />
      <StyledLink title={t("topStreams")} to="/streams" end>
        <svg viewBox="0 0 24 24">
          <path d="M15 10l4.553 -2.276a1 1 0 0 1 1.447 .894v6.764a1 1 0 0 1 -1.447 .894l-4.553 -2.276v-4z" />
          <rect x="3" y="6" width="12" height="12" rx="2" />
        </svg>
      </StyledLink>
      <StyledLink title={t("topCategories")} to="/categories">
        <svg viewBox="0 0 24 24">
      ...
      <Separator />
      <StyledLink title={t("search")} to="/search">
        <svg viewBox="0 0 24 24">
